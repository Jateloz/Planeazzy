...
define('SENDGRID_API_KEY',    'YOUR_SENDGRID_API_KEY_HERE');  // ← paste your SendGrid API key
define('SENDGRID_FROM_EMAIL', 'noreply@yourplaneazzydomain.com');  // ← verified sender
...
//  SMS (Africa's Talking — primary SMS for Kenya) 
// Sign up free at https://account.africastalking.com
// Use 'sandbox' username + key for testing, your real credentials for production
define('AT_USERNAME',   'sandbox');                        // ← your Africa's Talking username
define('AT_API_KEY',    'atsk_xxxxxxxxxxxxxxxxxxxxxxxx');  // ← your AT API key
define('AT_FROM',       'Planeazzy');                      // ← sender name (max 11 chars, pre-registered)
define('AT_SANDBOX',    APP_ENV === 'production');         // auto-switches sandbox in dev

//  App URL (for email links) 
define('APP_URL', APP_ENV === 'production' ? 'https://planeazzy.com' : 'http://localhost');
