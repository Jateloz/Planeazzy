...
$noSidebar=true; $pageTitle='Doctor Portal — Sign In';
...
<main style="flex:1;display:flex;align-items:center;justify-content:center;padding:48px 20px;background:var(--bg-light)">
  <div class="split-layout slide-up">
    <div class="split-left" style="background:linear-gradient(160deg,#0f172a,#0e7490,#0d9488)">
      <div class="split-left-hex"></div>
      <div class="split-left-content">
        <span class="portal-badge pb-teal" style="margin-bottom:16px"><i class="fa-solid fa-stethoscope"></i> Doctor Portal</span>
    ...
    <div class="split-right">
      <div style="max-width:380px;width:100%;margin:0 auto">
        <span class="portal-badge pb-teal"><i class="fa-solid fa-stethoscope"></i> Doctor Portal</span>
        ...
        <div class="form-group" style="margin-bottom:24px">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px">
            ...
            <a href="#" style="font-size:12px;font-weight:600;color:#0e7490"><span data-en="Forgot password?" data-sw="Umesahau nenosiri?">Forgot password?</span></a>
          </div>
        ...
        <button id="submitBtn" class="btn btn-primary btn-full btn-lg" style="background:#0e7490" onclick="doProviderLogin()"><i class="fa-solid fa-arrow-right-to-bracket"></i> Sign In to Doctor Portal</button>
        <div class="divider"><span><span data-en="New to Planeazzy?" data-sw="Mpya kwa Planeazzy?">New to Planeazzy?</span></div>
        <a href="/providers/doctor/register.php" class="btn btn-ghost btn-full"><i class="fa-solid fa-user-plus"></i> Register as Doctor Portal</a>
