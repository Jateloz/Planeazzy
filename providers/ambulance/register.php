...
$noSidebar = true;
$pageTitle = 'Ambulance Service Registration';
...
<main style="flex:1;display:flex;align-items:center;justify-content:center;padding:48px 20px;background:var(--bg-light)">
  <div style="width:100%;max-width:560px">
    <div class="auth-card slide-up">
      ...
      <div class="step-wrap">
        <div class="step-row">
          <span class="portal-badge pb-red"><i class="fa-solid fa-truck-medical"></i> Ambulance Service</span>
          <span class="step-pct">Registration</span>
        </div>
        <div class="prog-track"><div class="prog-fill" style="width:33%"></div></div>
      </div>
      <h2 style="font-size:22px;font-weight:900;color:var(--slate-900);margin-bottom:6px;letter-spacing:-.03em">Register as a Ambulance Service</h2>
      ...
      <input type="hidden" id="provType" value="ambulance">
      ...
      <div class="form-group"><label class="form-label"><span data-en="Specialty / Type" data-sw="Utaalamu / Aina">Specialty / Type</span> <span class="req">*</span></label>
        <div class="input-wrap"><i class="fa-solid fa-truck-medical input-ico" style="color:var(--red)"></i>
          <select id="pspecialty" class="form-select has-ico">
<?php if ('ambulance' === 'doctor'): ?>
...
<?php endif; ?>
      ...
      <button id="regBtn" class="btn btn-primary btn-full btn-lg" style="background:var(--red);margin-top:8px" onclick="doProviderRegister()">
        <i class="fa-solid fa-truck-medical"></i> Create Provider Account
      </button>
      <div class="divider"><span>Already registered?</span></div>
      <a href="/providers/ambulance/login.php" class="btn btn-ghost btn-full"><i class="fa-solid fa-arrow-right-to-bracket"></i> Sign In</a>
    </div>
  </div>
</main>
