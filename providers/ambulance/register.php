...
<main style="flex:1;display:flex;align-items:center;justify-content:center;padding:40px 20px;background:var(--bg);min-height:calc(100vh - 64px)">
  <div style="width:100%;max-width:560px">
    ...
    <div class="auth-card">
      ...
      <input type="hidden" id="ptype" value="<?= htmlspecialchars('ambulance') ?>">
      ...
      <a href="/providers/ambulance/login.php" class="btn btn-ghost btn-full">Sign In</a>
