...
$noSidebar=true; $pageTitle='Clinic Portal — Sign In';
...
<main style="flex:1;display:flex;align-items:center;justify-content:center;padding:48px 20px;background:var(--bg-light)">
  <div class="split-layout slide-up">
    <div class="split-left" style="background:linear-gradient(160deg,#064e3b,#059669,#10b981)">
      <div class="split-left-hex"></div>
      <div class="split-left-content">
        <span class="portal-badge pb-green" style="margin-bottom:16px"><i class="fa-solid fa-house-medical"></i> Clinic Portal</span>
    ...
    <div class="split-right">
      <div style="max-width:380px;width:100%;margin:0 auto">
        <span class="portal-badge pb-green"><i class="fa-solid fa-house-medical"></i> Clinic Portal</span>
        ...
        <div class="form-group" style="margin-bottom:24px">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px">
            ...
            <a href="#" style="font-size:12px;font-weight:600;color:#059669"><span data-en="Forgot password?" data-sw="Umesahau nenosiri?">Forgot password?</span></a>
          </div>
        ...
        <button id="submitBtn" class="btn btn-primary btn-full btn-lg" style="background:#059669" onclick="doProviderLogin()"><i class="fa-solid fa-arrow-right-to-bracket"></i> Sign In to Clinic Portal</button>
        <div class="divider"><span><span data-en="New to Planeazzy?" data-sw="Mpya kwa Planeazzy?">New to Planeazzy?</span></div>
        <a href="/providers/clinic/register.php" class="btn btn-ghost btn-full"><i class="fa-solid fa-user-plus"></i> Register as Clinic Portal</a>
