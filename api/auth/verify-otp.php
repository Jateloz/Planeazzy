<?php
/**
 * Planeazzy — POST /api/auth/verify-otp.php
 */
...
$ip = Security::ip();
if (!Security::rateLimit('otp:'.$ip, 15, 300)) {
    http_response_code(429);
    echo json_encode(['success'=>false,'message'=>'Too many attempts. Please wait.']); exit;
}
